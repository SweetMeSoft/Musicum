...
public interface Constantes {
    ...
    String ACCION_INICIAR = "com.millennialapps.musicum.INICIAR";
    String ACCION_REPRODUCIR = "com.millennialapps.musicum.REPRODUCIR";
    String ACCION_PAUSAR = "com.millennialapps.musicum.ACCION_PAUSAR";
    String ACCION_SIGUIENTE = "com.millennialapps.musicum.SIGUIENTE";
    String ACCION_ANTERIOR = "com.millennialapps.musicum.ANTERIOR";
    String ACCION_CREAR_LISTA = "com.millennialapps.musicum.ACCION_CREAR_LISTA";
    String ACCION_IR_A_CANCION = "com.millennialapps.musicum.ACCION_IR_A_CANCION";
